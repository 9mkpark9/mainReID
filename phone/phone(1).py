...
# 고개 숙임 각도 계산 (조건 4)
def detect_head_tilt(keypoints, head_angle_threshold=30, max_head_angle=60):
    if len(keypoints) < 17:
        return False
    ...
    return head_angle > head_angle_threshold and head_angle < max_head_angle
